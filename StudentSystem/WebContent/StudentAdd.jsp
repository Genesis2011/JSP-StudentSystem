...
<body>
	...
	<div id="wrap">
		<div id="top_content">
			...
			<form action="StudentAddControl" method="post" id="content">
				<p id="whereami"></p>
				<h1>添加学生：</h1>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="form_table">
					...
					<tr>
						...
						<td valign="middle" align="left">
							<input name="name" type="text" class="inputgri" />
						</td>
					</tr>
					<tr>
						<td valign="middle" align="right">学生密码:</td>
						<td valign="middle" align="left">
							<input name="password" type="text" class="inputgri" /> 
						</td>
					</tr>
					<tr>
						<td valign="middle" align="right">学生年龄:</td>
						<td valign="middle" align="left">
							<input name="age" type="text" class="inputgri" />
						</td>
					</tr>
					<tr>
						<td valign="middle" align="right">学生籍贯:</td>
						<td valign="middle" align="left">
							<input name="place" type="text" class="inputgri" />
						</td>
					</tr>
					<tr>
						<td valign="middle" align="right">学生电话:</td>
						<td valign="middle" align="left">
							<input name="phone" type="text" class="inputgri" />
						</td>
					</tr>
					<tr>
						<td valign="middle" align="right">学生QQ:</td>
						<td valign="middle" align="left">
							<input name="qq" type="text" class="inputgri" />
						</td>
					</tr>
					<tr>
						<td valign="middle" align="right">学生年级:</td>
						<td valign="middle" align="left">
							<input name="grade" type="text" class="inputgri" />
						</td>
					</tr>
				</table>
				<p>
					<input type="submit" class="button" value="确定" />
					<a href="StudentSelect.jsp"> <input type="button" class="button" value="取消" onclick="window.location.href('StudentSelect.jsp')"></a>
				</p>
			</form>
		</div>
