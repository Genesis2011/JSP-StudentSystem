				...
				<table cellpadding="0" cellspacing="0" border="0" class="form_table">
					...
					<tr>
						...
						<td valign="middle" align="left"><input
							value=" <%=s.getScore()%> " name="score" type="text"
							class="inputgri" /></td>
					</tr>
					<tr>
						<td valign="middle" align="right">科目:</td>
						<td valign="middle" align="left"><input
							value="<%=s.getCourse()%>" name="course" type="text"
							class="inputgri" /></td>
					</tr>
					<tr>
						<td valign="middle" align="right">考试时间:</td>
						<td valign="middle" align="left"><input
							value="<%=s.getTime()%> " name="time" type="text"
							class="inputgri" /></td>
					</tr>
					<tr>
						<td valign="middle" align="right">学号:</td>
						<td valign="middle" align="left"><input
							value="<%=s.getStudentid()%>" name="studentid" type="text"
							class="inputgri" /></td>
					</tr>
				</table>
				<p>
