...
<body>
	<div id="wrap">
		...
		<form action="StudentScoreAddControl" method="post" id="content">
			<p id="whereami"></p>
			<h1>添加成绩：</h1>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="form_table">
				<tr>
					...
					<td valign="middle" align="left">
						<input name="score" type="text" class="inputgri" />
					</td>
				</tr>
				<tr>
					<td valign="middle" align="right">科目:</td>
					<td valign="middle" align="left">
						<input name="course" type="text" class="inputgri" />
					</td>
				</tr>
				<tr>
					<td valign="middle" align="right">考试时间:</td>
					<td valign="middle" align="left">
						<input name="time" type="text" class="inputgri" />
					</td>
				</tr>
				<tr>
					<td valign="middle" align="right">学号:</td>
					<td valign="middle" align="left">
						<input name="studentid" type="text" class="inputgri" />
					</td>
				</tr>
			</table>
			<p>
				<input type="submit" class="button" value="确定" />
				<a href="StudentScoreSelect.jsp"> <input type="button" class="button" value="取消" onclick="window.location.href('StudentScoreSelect.jsp')"></a>
			</p>
		</form>
	</div>
